...
class Import_model extends CI_Model
{
    ...
    public function getDataDetail($ORDER_NO, $STYLE, $COLOR_DESC)
    {
        ...
        return $this->db->query("SELECT V1.GR_NO, V1.ORDER_NO, V1.WO_NO, V1.COLOR_DESC, V1.PRODUCT_CODE, V1.PORTION, V1.TABLE_INDEX, V1.STYLE, V1.TOTAL_QTY, V1.TOTAL_CUTTING, V1.PercentageCutting,
        V2.MaterialPlan, V2.QRNumber, V2.PO, V2.qProdCode, V2.qProdDesc, V2.qColorDesc, V2.qFabType, V2.qGrouping, V2.qLot,
        V2.QtyStickerKG, V2.QtyStickerYD, V2.Inspect, V2.ActualKG, V2.ActualYD, V2.ActWidth, V2.PlanWidth, V2.Spreading, V2.ConsKG, V2.ConsYD, V2.TtlLayer, V2.RejectRoll, V2.Residue
        FROM    dbo.vWebCutPlanHeader AS V1 INNER JOIN
        dbo.vWebCutPlanDetail AS V2 ON V1.GR_NO = V2.GRNo
        WHERE   V1.ORDER_NO = '$ORDER_NO' AND V1.STYLE = '$STYLE' AND V1.COLOR_DESC = '$COLOR_DESC'")->result();
