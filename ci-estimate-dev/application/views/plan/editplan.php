                                            ...
                                            <tr id="qtyRatio1">
                                                ...
                                                <?php foreach ($sizeratio as $ratio) : ?>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <input type="number" step="any" name="input_total_ratio" class="form-control" value="<?php echo $ratio->RATIO ?>">
                                                ...
                                                <!-- Input Total Ratio-->
                                                <td style="text-align: center;">
                                                    <input type="number" step="any" name="input_total_ratio" class="form-control" value="<?= $list['TOTAL_RATIO']; ?>">
                                                </td>

                                                <!-- Input Qty Layer -->
                                                <td style="text-align: center;">
                                                    <input type="number" step="any" name="input_qty_layer" class="form-control" value="<?= $list['QTY_LBR']; ?>">
                                                </td>

                                                <!-- Input Total QTY -->
                                                <td style="text-align: center;">
                                                    <input type="number" step="any" name="input_total_qty" class="form-control" value="<?= $list['TOTAL_QTY']; ?>">
                                                </td>

                                                <!-- Input Marker length -->
                                                <td style="text-align: center;">
                                                    <input type="number" step="any" name="marker_length_input" class="form-control" value="<?= $list['MARKER_LENGTH']; ?>">
                                                </td>
